...
public class BestMatch {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("_1Symbol", _1Symbol).append("_2Name", _2Name).append("_3Type", _3Type).append("_4Region", _4Region).append("_5MarketOpen", _5MarketOpen).append("_6MarketClose", _6MarketClose).append("_7Timezone", _7Timezone).append("_8Currency", _8Currency).append("_9MatchScore", _9MatchScore).toString();
    }
